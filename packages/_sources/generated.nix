...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  neovim = {
    pname = "neovim";
    version = "4863ca6b8902c5b0aab95f2af640118cd417d379";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-QHwx/NbIfsedzOMJQF29LqS+BebXAHpQVL9jQ5YsY+o=";
    };
    date = "2023-03-26";
  };
  noto-fonts-cjk = {
  ...
  yuzu-ea-appimage = {
    ...
    version = "EA-3476";
    src = fetchurl {
      url = "https://github.com/pineappleEA/pineapple-src/releases/download/EA-3476/Linux-Yuzu-EA-3476.AppImage";
      sha256 = "sha256-DUVrTO6kVM46OabGsDiJv02YCmzBavpeI/cSttvftgs=";
    };
  };
}

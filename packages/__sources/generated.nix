...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  neovim = {
    pname = "neovim";
    version = "ee986ee0449b828ca64bf7d4c69624596aab8319";
    src = fetchgit {
      url = "https://github.com/neovim/neovim";
      rev = "ee986ee0449b828ca64bf7d4c69624596aab8319";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-hha/bvJ02ALG4pXT1NqlaquiMYS8A5FkIpn+AKhoTo0=";
    };
    date = "2023-05-25";
  };
  noto-fonts-cjk = {
  ...
  yuzu-ea-appimage = {
    ...
    version = "EA-3611";
    src = fetchurl {
      url = "https://github.com/pineappleEA/pineapple-src/releases/download/EA-3611/Linux-Yuzu-EA-3611.AppImage";
      sha256 = "sha256-FvYs3yVE+C9gaS+h6I8HkyhaVW/BXp7tH+1JSy/0zoQ=";
    };
  };
}

...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  caddy = {
    pname = "caddy";
    version = "caddy-v2.7.6-24.01.29.39-45132fd51e8869ed";
    src = fetchurl {
      url = "https://github.com/MidAutumnMoon/Nuran/releases/download/caddy-v2.7.6-24.01.29.39-45132fd51e8869ed/caddy";
      sha256 = "sha256-XcAuYi4v25tjH/YfKLHkSLm5mLLoZHrpcET38RyTecw=";
    };
  };
  dnsproxy = {
    pname = "dnsproxy";
    version = "v0.64.0";
    src = fetchurl {
      url = "https://github.com/AdguardTeam/dnsproxy/releases/download/v0.64.0/dnsproxy-linux-amd64-v0.64.0.tar.gz";
      sha256 = "sha256-fPclmvhLXF2CZlO02dBTizZB/4mE38xH7KcvOt5cD8I=";
    };
  };
  graphite-cursors = {

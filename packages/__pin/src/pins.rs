...
/// pins.json: system -> package. Generated by the refresh manifest and
/// consumed directly by the root overlay.
pub type Pins = BTreeMap<String, BTreeMap<String, Pin>>;

/// One output in the derivation's declared order. The first is the
...
/// Everything the root overlay needs to hydrate one package.
#[derive(Debug)]
#[derive(Clone)]
#[derive(Eq)]
#[derive(PartialEq)]
